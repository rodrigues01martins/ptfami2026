  ...
  <option key={item.id} value={item.id}>
    {item.id} - {item.desc} {/* Mudamos de .description para .desc */}
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2"><FileText size={12} /> NF / Documento</label>
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2"><Building2 size={12} /> Fornecedor</label>
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider flex items-center gap-2"><DollarSign size={12} /> Valor (R$)</label>
      ...
      <button type="submit" className="w-full mt-8 bg-[#00735C] text-white font-bold py-4 rounded-2xl shadow-lg shadow-[#00735C]/20 hover:bg-[#005c4a] transition-all">Salvar Lançamento</button>
    </form>
  );
};
